...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('system.house-types.index') }}">
...
{{-- <div class="card">
    ...
    <div class="tab-content tw-px-5 tw-pt-5">
        <div class="tab-pane active" role="tabpanel" id="house_type_manage_houses">
            @includeIf('system.houseTypes.relationships.houseTypeManageHouses', ['manageHouses' => $houseType->houseTypeManageHouses])
        </div>
        <div class="tab-pane" role="tabpanel" id="house_type_manage_prices">
            @includeIf('system.houseTypes.relationships.houseTypeManagePrices', ['managePrices' => $houseType->houseTypeManagePrices])
        </div>
    </div>
</div> --}}
