                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="budget" id="budget" value="{{ old('budget', $product->budget) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="handler_by_id" id="handler_by_id">
