                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.open-projects.update", [$openProject->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $openProject->description) !!}</textarea>
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                xhr.open('POST', '{{ route('frontend.open-projects.storeCKEditorImages') }}', true);
