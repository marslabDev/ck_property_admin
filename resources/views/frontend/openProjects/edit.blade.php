                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.open-projects.update", [$openProject->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="budget" id="budget" value="{{ old('budget', $openProject->budget) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="suppliers[]" id="suppliers" multiple required>
