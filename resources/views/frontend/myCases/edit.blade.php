                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.my-cases.update", [$myCase->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" id="location" value="{{ old('location', $myCase->location) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="urgent_status" id="urgent_status" value="{{ old('urgent_status', $myCase->urgent_status) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="progress" id="progress" value="{{ old('progress', $myCase->progress) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $myCase->description) }}</textarea>
