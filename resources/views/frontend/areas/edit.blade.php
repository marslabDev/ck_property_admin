                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.areas.update", [$area->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $area->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="office_no" id="office_no" value="{{ old('office_no', $area->office_no) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address_line" id="address_line" required>{{ old('address_line', $area->address_line) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address_line_2" id="address_line_2">{{ old('address_line_2', $area->address_line_2) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $area->city) }}" required>
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('city') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $area->state) }}" required>
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('state') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="country" id="country" value="{{ old('country', $area->country) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="price_per_ft" id="price_per_ft" value="{{ old('price_per_ft', $area->price_per_ft) }}" step="0.01" required>
