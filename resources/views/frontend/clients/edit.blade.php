                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.clients.update", [$client->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="person_in_change" id="person_in_change" value="{{ old('person_in_change', $client->person_in_change) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="desc" id="desc" value="{{ old('desc', $client->desc) }}">
                            @if($errors->has('desc'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('desc') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="whatapps" id="whatapps" value="{{ old('whatapps', $client->whatapps) }}" required>
