            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-BillHistory">
                            <thead>
                                <tr>
                                    <th>
...
<script>
  ...
  let table = $('.datatable-BillHistory:not(.ajaxTable)').DataTable({ buttons: dtButtons })
