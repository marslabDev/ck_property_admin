                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.update", [$user->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_no" id="phone_no" value="{{ old('phone_no', $user->phone_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="card_no" id="card_no" value="{{ old('card_no', $user->card_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gender" id="gender" value="{{ old('gender', $user->gender) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="join_date" id="join_date" value="{{ old('join_date', $user->join_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="address_line_2" id="address_line_2">{{ old('address_line_2', $user->address_line_2) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="state" id="state" value="{{ old('state', $user->state) }}" required>
                            @if($errors->has('state'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('state') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="postal_code" id="postal_code" value="{{ old('postal_code', $user->postal_code) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="manage_area" id="manage_area">
