                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="card_no" id="card_no" value="{{ old('card_no', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="gender" id="gender" value="{{ old('gender', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="postal_code" id="postal_code" value="{{ old('postal_code', '') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="manage_area" id="manage_area">
                                ...
                                @foreach(App\Models\User::MANAGE_AREA_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('manage_area', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
