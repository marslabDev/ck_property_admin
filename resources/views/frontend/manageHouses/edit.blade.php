    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.manage-houses.update", [$manageHouse->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="unit_no" id="unit_no" value="{{ old('unit_no', $manageHouse->unit_no) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="floor" id="floor" value="{{ old('floor', $manageHouse->floor) }}">
                            @if($errors->has('floor'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('floor') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="block" id="block" value="{{ old('block', $manageHouse->block) }}">
                            @if($errors->has('block'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('block') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="street_id" id="street_id" required>
                                @foreach($streets as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('street_id') ? old('street_id') : $manageHouse->street->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="square_feet" id="square_feet" value="{{ old('square_feet', $manageHouse->square_feet) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="parking_lots[]" id="parking_lots" multiple>
                                @foreach($parking_lots as $id => $parking_lot)
                                    <option value="{{ $id }}" {{ (in_array($id, old('parking_lots', [])) || $manageHouse->parking_lots->contains($id)) ? 'selected' : '' }}>{{ $parking_lot }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="house_status_id" id="house_status_id" required>
                                @foreach($house_statuses as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('house_status_id') ? old('house_status_id') : $manageHouse->house_status->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="owned_bies[]" id="owned_bies" multiple>
                                @foreach($owned_bies as $id => $owned_by)
                                    <option value="{{ $id }}" {{ (in_array($id, old('owned_bies', [])) || $manageHouse->owned_bies->contains($id)) ? 'selected' : '' }}>{{ $owned_by }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="contact_person_id" id="contact_person_id" required>
                                @foreach($contact_people as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('contact_person_id') ? old('contact_person_id') : $manageHouse->contact_person->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="contact_person_2_id" id="contact_person_2_id">
                                @foreach($contact_person_2s as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('contact_person_2_id') ? old('contact_person_2_id') : $manageHouse->contact_person_2->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
