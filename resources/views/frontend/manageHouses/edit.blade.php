                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.manage-houses.update", [$manageHouse->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="street" id="street" value="{{ old('street', $manageHouse->street) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="taman" id="taman" value="{{ old('taman', $manageHouse->taman) }}" required>
                            @if($errors->has('taman'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('taman') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="house_status" id="house_status" required>
                                ...
                                @foreach(App\Models\ManageHouse::HOUSE_STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('house_status', $manageHouse->house_status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
