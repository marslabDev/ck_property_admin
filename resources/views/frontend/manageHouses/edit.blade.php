                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.manage-houses.update", [$manageHouse->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_name" id="contact_name" value="{{ old('contact_name', $manageHouse->contact_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="contact_no" id="contact_no" value="{{ old('contact_no', $manageHouse->contact_no) }}" step="0.01">
