    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-charges.update", [$paymentCharge->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="particular">{{ trans('cruds.paymentCharge.fields.particular') }}</label>
                            <input class="form-control" type="text" name="particular" id="particular" value="{{ old('particular', $paymentCharge->particular) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $paymentCharge->amount) }}" step="0.01" required>
