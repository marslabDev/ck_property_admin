    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bills.update", [$bill->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="billplz">{{ trans('cruds.bill.fields.billplz') }}</label>
                            <input class="form-control" type="text" name="billplz" id="billplz" value="{{ old('billplz', $bill->billplz) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="billplz_url" id="billplz_url" value="{{ old('billplz_url', $bill->billplz_url) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="bill_type_id" id="bill_type_id" required>
                                @foreach($bill_types as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('bill_type_id') ? old('bill_type_id') : $bill->bill_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="billing_date" id="billing_date" value="{{ old('billing_date', $bill->billing_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="due_date" id="due_date" value="{{ old('due_date', $bill->due_date) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $bill->amount) }}" step="0.01" required>
