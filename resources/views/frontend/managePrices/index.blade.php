        ...
        <div class="col-md-12">
            @can('manage_price_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.manage-prices.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-ManagePrice">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $managePrice->id }}">
                                        ...
                                        <td>
                                            @can('manage_price_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.manage-prices.show', $managePrice->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('manage_price_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.manage-prices.edit', $managePrice->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('manage_price_delete')
                                                <form action="{{ route('frontend.manage-prices.destroy', $managePrice->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('manage_price_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.manage-prices.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-ManagePrice:not(.ajaxTable)').DataTable({ buttons: dtButtons })
