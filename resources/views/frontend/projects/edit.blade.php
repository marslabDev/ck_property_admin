                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.update", [$project->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $project->start_date) }}" required>
                        ...
                        <div class="form-group">
                            <label for="documents">{{ trans('cruds.project.fields.documents') }}</label>
                            <input class="form-control" type="text" name="documents" id="documents" value="{{ old('documents', $project->documents) }}">
                            @if($errors->has('documents'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('documents') }}
                                </div>
                            @endif
                            <span class="help-block">{{ trans('cruds.project.fields.documents_helper') }}</span>
                        </div>
                        <div class="form-group">
