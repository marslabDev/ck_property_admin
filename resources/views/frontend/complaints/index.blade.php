                            ...
                            <tbody>
                                @foreach($complaints as $key => $complaint)
                                    <tr data-entry-id="{{ $complaint->id }}">
                                        ...
                                        <td>
                                            @can('complaint_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.complaints.show', $complaint->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('complaint_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.complaints.edit', $complaint->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('complaint_delete')
                                                <form action="{{ route('frontend.complaints.destroy', $complaint->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('complaint_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.complaints.massDestroy') }}",
