    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.articles.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="title_name">{{ trans('cruds.article.fields.title_name') }}</label>
                            <input class="form-control" type="text" name="title_name" id="title_name" value="{{ old('title_name', '') }}" required>
