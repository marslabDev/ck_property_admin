    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-plans.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="due_date" id="due_date" value="{{ old('due_date') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="payments[]" id="payments" multiple required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="recusive_payment" id="recusive_payment" value="1" {{ old('recusive_payment', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cycle_every" id="cycle_every" value="{{ old('cycle_every', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="cycle_by" id="cycle_by">
                                ...
                                @foreach(App\Models\PaymentPlan::CYCLE_BY_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('cycle_by', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="no_of_cycle" id="no_of_cycle" value="{{ old('no_of_cycle', '') }}" step="1">
