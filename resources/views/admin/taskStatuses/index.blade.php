...
@can('task_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.task-statuses.create', [currentArea()]) }}">
...
@can('task_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.task-statuses.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.task-statuses.index', [currentArea()]) }}",
    columns: [
