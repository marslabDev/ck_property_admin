...
@can('transaction_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.transaction-types.create', [currentArea()]) }}">
...
@can('transaction_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.transaction-types.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.transaction-types.index', [currentArea()]) }}",
    columns: [
