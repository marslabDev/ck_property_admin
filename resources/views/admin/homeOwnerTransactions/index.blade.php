...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-HomeOwnerTransaction">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'payment_plan_due_date', name: 'payment_plan.due_date' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-HomeOwnerTransaction').DataTable(dtOverrideGlobals);
