...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.home-owner-transactions.update", [$homeOwnerTransaction->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount_paid') ? 'is-invalid' : '' }}" type="number" name="amount_paid" id="amount_paid" value="{{ old('amount_paid', $homeOwnerTransaction->amount_paid) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('changes') ? 'is-invalid' : '' }}" type="number" name="changes" id="changes" value="{{ old('changes', $homeOwnerTransaction->changes) }}" step="0.01" required>
