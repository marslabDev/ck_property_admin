...
@can('expense_category_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.expense-categories.create', [currentArea()]) }}">
...
@can('expense_category_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.expense-categories.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.expense-categories.index', [currentArea()]) }}",
    columns: [
