...
@can('project_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.projects.create', [currentArea()]) }}">
...
@can('project_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.projects.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.projects.index', [currentArea()]) }}",
    columns: [
