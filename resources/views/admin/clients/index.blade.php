...
@can('client_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.clients.create', [currentArea()]) }}">
...
@can('client_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.clients.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.clients.index', [currentArea()]) }}",
    columns: [
