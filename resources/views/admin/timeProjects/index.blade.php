...
@can('time_project_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.time-projects.create', [currentArea()]) }}">
...
@can('time_project_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.time-projects.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.time-projects.index', [currentArea()]) }}",
    columns: [
