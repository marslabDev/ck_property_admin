    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.manage-houses.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group" id="house_type_id_field">
                <input type="hidden" id="house_type_type" name="house_type_type" value="">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_no') ? 'is-invalid' : '' }}" type="text" name="unit_no"
                    id="unit_no" value="{{ old('unit_no', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('square_feet') ? 'is-invalid' : '' }}" type="number"
                    name="square_feet" id="square_feet" value="{{ old('square_feet', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('parking_lots') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}" {{ in_array($id, old('parking_lots', [])) ? 'selected' : '' }}>{{
                        $parking_lot }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('owned_bies') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}" {{ in_array($id, old('owned_bies', [])) ? 'selected' : '' }}>{{ $owned_by
                        }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contact_person') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $contact_person->id }}" {{ old('contact_person_id')==$contact_person->id ?
                        'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contact_person_2') ? 'is-invalid' : '' }}"
                    ...
                    <option value="{{ $id }}" {{ old('contact_person_2_id')==$contact_person_2->id ? 'selected' : '' }}>
