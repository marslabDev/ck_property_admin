    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manage-houses.update", [$manageHouse->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spuare_feet') ? 'is-invalid' : '' }}" type="number" name="spuare_feet" id="spuare_feet" value="{{ old('spuare_feet', $manageHouse->spuare_feet) }}" step="1" required>
