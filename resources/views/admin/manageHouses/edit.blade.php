...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manage-houses.update", [$manageHouse->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('house_status') ? 'is-invalid' : '' }}" name="house_status_id" id="house_status_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contact_person') ? 'is-invalid' : '' }}" name="contact_person_id" id="contact_person_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('contact_person_2') ? 'is-invalid' : '' }}" name="contact_person_2_id" id="contact_person_2_id">
