...
@can('asset_location_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.asset-locations.create', [currentArea()]) }}">
...
@can('asset_location_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.asset-locations.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.asset-locations.index', [currentArea()]) }}",
    columns: [
