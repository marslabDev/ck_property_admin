    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.my-cases.update", [$myCase->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('opened_at') ? 'is-invalid' : '' }}" type="text" name="opened_at" id="opened_at" value="{{ old('opened_at', $myCase->opened_at) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $myCase->description) !!}</textarea>
