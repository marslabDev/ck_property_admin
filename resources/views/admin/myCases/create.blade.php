    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.my-cases.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('urgent_status') ? 'is-invalid' : '' }}" type="text" name="urgent_status" id="urgent_status" value="{{ old('urgent_status', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_reported') ? 'is-invalid' : '' }}" type="text" name="date_reported" id="date_reported" value="{{ old('date_reported') }}" required>
