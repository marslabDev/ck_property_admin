...
@can('income_source_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.income-sources.create', [currentArea()]) }}">
...
@can('income_source_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.income-sources.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.income-sources.index', [currentArea()]) }}",
    columns: [
