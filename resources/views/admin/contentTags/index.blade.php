...
@can('content_tag_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.content-tags.create', [currentArea()]) }}">
...
@can('content_tag_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.content-tags.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.content-tags.index', [currentArea()]) }}",
    columns: [
