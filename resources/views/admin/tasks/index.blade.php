...
@can('task_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.tasks.create', [currentArea()]) }}">
...
@can('task_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.tasks.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.tasks.index', [currentArea()]) }}",
    columns: [
