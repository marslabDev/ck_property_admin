...
@can('note_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.notes.create', [currentArea()]) }}">
...
@can('note_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.notes.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.notes.index', [currentArea()]) }}",
    columns: [
