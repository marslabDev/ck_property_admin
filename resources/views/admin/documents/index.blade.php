...
@can('document_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.documents.create', [currentArea()]) }}">
...
@can('document_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.documents.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.documents.index', [currentArea()]) }}",
    columns: [
