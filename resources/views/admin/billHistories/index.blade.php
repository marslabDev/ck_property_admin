...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BillHistory">
            <thead>
                <tr>
                    <th width="10">
...
<script>
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.bill-histories.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'paid_by_name', name: 'paid_by.name' },
{ data: 'paid_by.email', name: 'paid_by.email' },
{ data: 'bill_amount', name: 'bill.amount' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-BillHistory').DataTable(dtOverrideGlobals);
