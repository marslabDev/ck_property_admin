...
@can('expense_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.expenses.create', [currentArea()]) }}">
...
@can('expense_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.expenses.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.expenses.index', [currentArea()]) }}",
    columns: [
