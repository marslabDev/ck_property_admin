...
@can('asset_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.assets.create', [currentArea()]) }}">
...
@can('asset_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.assets.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.assets.index', [currentArea()]) }}",
    columns: [
