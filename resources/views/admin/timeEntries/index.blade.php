...
@can('time_entry_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.time-entries.create', [currentArea()]) }}">
...
@can('time_entry_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.time-entries.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.time-entries.index', [currentArea()]) }}",
    columns: [
