...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.parking-lots.update', [currentArea(), $parkingLot->id]) }}"
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lot_no') ? 'is-invalid' : '' }}" type="text" name="lot_no"
                    id="lot_no" value="{{ old('lot_no', $parkingLot->lot_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('floor') ? 'is-invalid' : '' }}" type="number" name="floor"
                    id="floor" value="{{ old('floor', $parkingLot->floor) }}" step="1">
                @if($errors->has('floor'))
                <div class="invalid-feedback">
                    {{ $errors->first('floor') }}
                </div>
