...
@can('product_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.products.create', [currentArea()]) }}">
                ...
                <tr>
                    ...
                    <td>
                        <select class="search" strict="true">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach(App\Models\Product::TARGET_LOCATION_SELECT as $key => $item)
...
@can('product_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.products.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.products.index', [currentArea()]) }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'title', name: 'title' },
{ data: 'budget', name: 'budget' },
{ data: 'handler_by_name', name: 'handler_by.name' },
