...
@can('complaint_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.complaints.create', [currentArea()]) }}">
...
@can('complaint_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.complaints.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.complaints.index', [currentArea()]) }}",
    columns: [
