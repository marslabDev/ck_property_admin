    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notices.update", [$notice->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_name') ? 'is-invalid' : '' }}" type="text" name="title_name" id="title_name" value="{{ old('title_name', $notice->title_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('detail') ? 'is-invalid' : '' }}" name="detail" id="detail" required>{{ old('detail', $notice->detail) }}</textarea>
