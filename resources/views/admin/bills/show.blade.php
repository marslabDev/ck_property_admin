...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#bill_bill_items" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="bill_bill_items">
            @includeIf('admin.bills.relationships.billBillItems', ['billItems' => $bill->billBillItems])
        </div>
    </div>
</div>
