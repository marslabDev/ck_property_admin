    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.bills.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billplz') ? 'is-invalid' : '' }}" type="text" name="billplz" id="billplz" value="{{ old('billplz', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('billplz_url') ? 'is-invalid' : '' }}" type="text" name="billplz_url" id="billplz_url" value="{{ old('billplz_url', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('bill_type') ? 'is-invalid' : '' }}" name="bill_type_id" id="bill_type_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('billing_date') ? 'is-invalid' : '' }}" type="text" name="billing_date" id="billing_date" value="{{ old('billing_date') }}" required>
