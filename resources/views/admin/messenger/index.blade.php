        ...
        <div class="list-group">
            @forelse($topics as $topic)
                <div class="row list-group-item d-flex">
                    <div class="col-lg-4">
                        <a href="{{ route('admin.messenger.showMessages', [$topic->id], [currentArea()]) }}">
                    ...
                    <div class="col-lg-1 text-center">
                        <form action="{{ route('admin.messenger.destroyTopic', [$topic->id], [currentArea()]) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');">
