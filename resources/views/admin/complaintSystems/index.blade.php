...
@can('complaint_system_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.complaint-systems.create', [currentArea()]) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ComplaintSystem">
            <thead>
                <tr>
                    <th width="10">
...
@can('complaint_system_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.complaint-systems.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.complaint-systems.index', [currentArea()]) }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ComplaintSystem').DataTable(dtOverrideGlobals);
