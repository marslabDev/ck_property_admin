...
@can('case_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.case-statuses.create', [currentArea()]) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CaseStatus">
            <thead>
                <tr>
                    <th width="10">
...
@can('case_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.case-statuses.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.case-statuses.index', [currentArea()]) }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CaseStatus').DataTable(dtOverrideGlobals);
