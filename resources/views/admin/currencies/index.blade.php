...
@can('currency_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.currencies.create', [currentArea()]) }}">
...
@can('currency_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.currencies.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.currencies.index', [currentArea()]) }}",
    columns: [
