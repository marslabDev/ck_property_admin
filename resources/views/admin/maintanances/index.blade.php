...
@can('maintanance_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.maintanances.create', [currentArea()]) }}">
...
@can('maintanance_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.maintanances.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.maintanances.index', [currentArea()]) }}",
    columns: [
