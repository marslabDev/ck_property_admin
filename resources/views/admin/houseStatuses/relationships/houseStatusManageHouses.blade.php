...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-houseStatusManageHouses">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr data-entry-id="{{ $manageHouse->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-primary"
                                href="{{ route('admin.manage-houses.show', [currentArea(), $manageHouse->id]) }}">
                                {{ trans('global.view') }}
                            </a>
                            @endcan
                            ...
                            <a class="btn btn-xs btn-info"
                                href="{{ route('admin.manage-houses.edit', [currentArea(), $manageHouse->id]) }}">
                                {{ trans('global.edit') }}
                            </a>
                            @endcan

                            @can('manage_house_delete')
                            <form action="{{ route('admin.manage-houses.destroy', [currentArea(), $manageHouse->id]) }}"
...
@endcan
  ...
  let table = $('.datatable-houseStatusManageHouses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
