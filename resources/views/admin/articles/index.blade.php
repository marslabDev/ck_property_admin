...
@can('article_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.articles.create', [currentArea()]) }}">
...
@can('article_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.articles.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.articles.index', [currentArea()]) }}",
    columns: [
...
{ data: 'people_in_area.address_line', name: 'people_in_area.address_line' },
