...
@can('project_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.project-statuses.create', [currentArea()]) }}">
...
@can('project_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.project-statuses.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.project-statuses.index', [currentArea()]) }}",
    columns: [
