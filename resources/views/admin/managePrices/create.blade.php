...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.manage-prices.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('price_per_sq_ft') ? 'is-invalid' : '' }}" type="number" name="price_per_sq_ft" id="price_per_sq_ft" value="{{ old('price_per_sq_ft', '') }}" step="0.01" required>
