...
@can('content_page_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.content-pages.create', [currentArea()]) }}">
...
@can('content_page_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.content-pages.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.content-pages.index', [currentArea()]) }}",
    columns: [
