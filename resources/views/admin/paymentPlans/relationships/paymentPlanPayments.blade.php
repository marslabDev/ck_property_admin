...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-paymentPlanPayments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.payment.fields.unti_price') }}
                        </th>
                        <th>
                            {{ trans('cruds.payment.fields.payment_plan') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($payments as $key => $payment)
                        <tr data-entry-id="{{ $payment->id }}">
                            ...
                            <td>
                                @foreach($payment->payment_plans as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-paymentPlanPayments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
