    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payment-plans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('due_date') ? 'is-invalid' : '' }}" type="text" name="due_date" id="due_date" value="{{ old('due_date') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('due_day') ? 'is-invalid' : '' }}" name="due_day" id="due_day" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cycle_every') ? 'is-invalid' : '' }}" type="number" name="cycle_every" id="cycle_every" value="{{ old('cycle_every', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_cycle') ? 'is-invalid' : '' }}" type="number" name="no_of_cycle" id="no_of_cycle" value="{{ old('no_of_cycle', '') }}" step="1">
