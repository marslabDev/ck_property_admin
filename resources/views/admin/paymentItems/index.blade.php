...
@can('payment_item_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.payment-items.create', [currentArea()]) }}">
...
@can('payment_item_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.payment-items.massDestroy', [currentArea()]) }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.payment-items.index', [currentArea()]) }}",
    columns: [
