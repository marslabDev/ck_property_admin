@can('payment_type_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.payment-types.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaPaymentTypes">
                <thead>
                    <tr>
                        <th width="10">
...
@can('payment_type_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.payment-types.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaPaymentTypes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
