@can('complaint_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.complaints.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaComplaints">
                <thead>
                    <tr>
                        <th width="10">
...
@can('complaint_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.complaints.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaComplaints:not(.ajaxTable)').DataTable({ buttons: dtButtons })
