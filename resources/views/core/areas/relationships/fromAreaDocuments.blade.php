@can('document_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.documents.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaDocuments">
                <thead>
                    <tr>
                        <th width="10">
...
@can('document_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.documents.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaDocuments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
