@can('note_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.notes.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaNotes">
                <thead>
                    <tr>
                        <th width="10">
...
@can('note_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.notes.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaNotes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
