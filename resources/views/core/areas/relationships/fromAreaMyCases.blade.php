@can('my_case_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.my-cases.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaMyCases">
                <thead>
                    <tr>
                        <th width="10">
...
@can('my_case_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.my-cases.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaMyCases:not(.ajaxTable)').DataTable({ buttons: dtButtons })
