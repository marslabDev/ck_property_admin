@can('project_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.projects.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaProjects">
                <thead>
                    <tr>
                        <th width="10">
...
@can('project_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.projects.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaProjects:not(.ajaxTable)').DataTable({ buttons: dtButtons })
