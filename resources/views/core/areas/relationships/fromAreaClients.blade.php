@can('client_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.clients.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaClients">
                <thead>
                    <tr>
                        <th width="10">
...
@can('client_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.clients.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaClients:not(.ajaxTable)').DataTable({ buttons: dtButtons })
