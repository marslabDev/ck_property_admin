@can('task_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.task-statuses.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaTaskStatuses">
                <thead>
                    <tr>
                        <th width="10">
...
@can('task_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.task-statuses.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaTaskStatuses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
