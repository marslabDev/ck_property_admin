@can('manage_house_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.manage-houses.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaManageHouses">
                <thead>
                    <tr>
                        <th width="10">
...
@can('manage_house_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.manage-houses.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaManageHouses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
