@can('client_status_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.client-statuses.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaClientStatuses">
                <thead>
                    <tr>
                        <th width="10">
...
@can('client_status_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.client-statuses.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaClientStatuses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
