@can('task_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.tasks.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaTasks">
                <thead>
                    <tr>
                        <th width="10">
...
@can('task_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.tasks.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
