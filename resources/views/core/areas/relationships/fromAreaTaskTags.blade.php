@can('task_tag_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.task-tags.create', $area) }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-fromAreaTaskTags">
                <thead>
                    <tr>
                        <th width="10">
...
@can('task_tag_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.task-tags.massDestroy', $area) }}",
...
@endcan
  ...
  let table = $('.datatable-fromAreaTaskTags:not(.ajaxTable)').DataTable({ buttons: dtButtons })
