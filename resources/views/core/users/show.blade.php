...
@include('partials.core.userNavs')
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('core.users.index') }}">
...
<div class="card">
    ...
    <div class="tab-content tw-px-5 tw-pt-5">
        <div class="tab-pane" role="tabpanel" id="created_by_my_cases">
            {{-- @includeIf('core.users.relationships.createdByMyCases', ['myCases' => $user->createdByMyCases]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="user_user_details">
            @includeIf('core.users.relationships.userUserDetails', ['userDetails' => $user->userUserDetails])
        </div>
        <div class="tab-pane" role="tabpanel" id="user_user_card_mgmts">
            @includeIf('core.users.relationships.userUserCardMgmts', ['userCardMgmts' => $user->userUserCardMgmts])
        </div>
        <div class="tab-pane" role="tabpanel" id="user_payment_plans">
            {{-- @includeIf('core.users.relationships.userPaymentPlans', ['paymentPlans' => $user->userPaymentPlans]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="user_home_owner_transactions">
            {{-- @includeIf('core.users.relationships.userHomeOwnerTransactions', ['homeOwnerTransactions' => $user->userHomeOwnerTransactions]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="created_by_home_owner_transactions">
            {{-- @includeIf('core.users.relationships.createdByHomeOwnerTransactions', ['homeOwnerTransactions' => $user->createdByHomeOwnerTransactions]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="contact_person_manage_houses">
            {{-- @includeIf('core.users.relationships.contactPersonManageHouses', ['manageHouses' => $user->contactPersonManageHouses]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="contact_person2_manage_houses">
            {{-- @includeIf('core.users.relationships.contactPerson2ManageHouses', ['manageHouses' => $user->contactPerson2ManageHouses]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="handle_by_my_cases">
            {{-- @includeIf('core.users.relationships.handleByMyCases', ['myCases' => $user->handleByMyCases]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="report_to_my_cases">
            {{-- @includeIf('core.users.relationships.reportToMyCases', ['myCases' => $user->reportToMyCases]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="user_user_alerts">
            {{-- @includeIf('core.users.relationships.userUserAlerts', ['userAlerts' => $user->userUserAlerts]) --}}
        </div>
        <div class="tab-pane" role="tabpanel" id="owned_by_manage_houses">
            {{-- @includeIf('core.users.relationships.ownedByManageHouses', ['manageHouses' => $user->ownedByManageHouses]) --}}
        </div>
    </div>
</div>
