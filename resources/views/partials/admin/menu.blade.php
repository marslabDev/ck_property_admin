<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <div class="c-sidebar-brand">
        <a class="c-sidebar-brand-full h5 text-center tw-pb-1" href="{{ route('admin.home', [currentArea()]) }}">
    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <a href="{{ route('admin.home', [currentArea()]) }}" class="c-sidebar-nav-link">
        ...
        @can('audit_log_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.audit-logs.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/audit-logs") || request()->is("admin/audit-logs/*") ? "c-active" : "" }}">
        ...
        @can('notice_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.notices.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/notices") || request()->is("admin/notices/*") ? "c-active" : "" }}">
        ...
        @can('article_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.articles.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/articles") || request()->is("admin/articles/*") ? "c-active" : "" }}">
        ...
        @can('user_alert_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.user-alerts.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/user-alerts") || request()->is("admin/user-alerts/*") ? "c-active" : "" }}">
        ...
        @can('house_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/*/streets*") ? "c-show" : "" }} {{ request()->is("admin/*/parking-lots*") ? "c-show" : "" }} {{ request()->is("admin/*/house-types*") ? "c-show" : "" }} {{ request()->is("admin/*/manage-houses*") ? "c-show" : "" }} {{ request()->is("admin/*/manage-prices*") ? "c-show" : "" }} {{ request()->is("admin/*/house-statuses*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route('admin.manage-houses.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/*/manage-houses") || request()->is("admin/*/manage-houses/*") ? "c-active" : "" }}">
                    ...
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route('admin.manage-prices.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/*/manage-prices") || request()->is("admin/*/manage-prices/*") ? "c-active" : "" }}">
                    ...
                    @can('street_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.streets.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/*/streets") || request()->is("admin/*/streets/*") ? "c-active" : "" }}">
                    ...
                    @can('parking_lot_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.parking-lots.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/*/parking-lots") || request()->is("admin/*/parking-lots/*") ? "c-active" : "" }}">
                    ...
                    @can('house_type_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.house-types.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/*/house-types") || request()->is("admin/*/house-types/*") ? "c-active" : "" }}">
        ...
        @can('complaint_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/my-cases*") ? "c-show" : "" }} {{ request()->is("admin/complaints*") ? "c-show" : "" }} {{ request()->is("admin/case-statuses*") ? "c-show" : "" }} {{ request()->is("admin/cases-categories*") ? "c-show" : "" }} {{ request()->is("admin/complaint-statuses*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('my_case_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.my-cases.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/my-cases") || request()->is("admin/my-cases/*") ? "c-active" : "" }}">
                    ...
                    @can('complaint_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('admin.complaints.index', [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/complaints") || request()->is("admin/complaints/*") ? "c-active" : "" }}">
            ...
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/home-owner-transactions*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('home_owner_transaction_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.home-owner-transactions.index", [currentArea()]) }}" class="c-sidebar-nav-link {{ request()->is("admin/home-owner-transactions") || request()->is("admin/home-owner-transactions/*") ? "c-active" : "" }}">
                                <i class="fa-fw fas fa-exchange-alt c-sidebar-nav-icon">
