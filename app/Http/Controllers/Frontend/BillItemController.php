...
class BillItemController extends Controller
{
    ...
    public function index()
    {
        ...
        $billItems = BillItem::with(['bill_particular', 'bill', 'from_area', 'created_by'])->get();
        ...
        return view('frontend.billItems.index', compact('areas', 'billItems', 'bill_particulars', 'bills', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.billItems.create', compact('bill_particulars', 'bills'));
    }
    ...
    public function edit(BillItem $billItem)
    {
        ...
        return view('frontend.billItems.edit', compact('billItem', 'bill_particulars', 'bills'));
    }
