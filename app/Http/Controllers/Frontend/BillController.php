...
class BillController extends Controller
{
    ...
    public function index()
    {
        ...
        $bills = Bill::with(['house', 'homeowner', 'bill_items', 'bill_charges', 'bill_status', 'from_area', 'created_by'])->get();
        ...
        return view('frontend.bills.index', compact('areas', 'bill_charges', 'bill_items', 'bill_statuses', 'bills', 'manage_houses', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bills.create', compact('bill_charges', 'bill_items', 'bill_statuses', 'homeowners', 'houses'));
    }
    ...
    public function edit(Bill $bill)
    {
        ...
        return view('frontend.bills.edit', compact('bill', 'bill_charges', 'bill_items', 'bill_statuses', 'homeowners', 'houses'));
    }
    ...
    public function show(Bill $bill)
    {
        ...
        $bill->load('house', 'homeowner', 'bill_items', 'bill_charges', 'bill_status', 'from_area', 'created_by', 'billBillHistories');
