...
class NoticesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new NoticeResource(Notice::with(['people_in_role', 'people_in_area', 'create_by', 'created_by'])->get());
    }
    ...
    public function show(Notice $notice)
    {
        ...
        return new NoticeResource($notice->load(['people_in_role', 'people_in_area', 'create_by', 'created_by']));
    }
