...
class ProjectApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ProjectResource(Project::with(['areas', 'suppliers', 'status', 'from_area', 'created_by'])->get());
    }
    ...
    public function show(Project $project)
    {
        ...
        return new ProjectResource($project->load(['areas', 'suppliers', 'status', 'from_area', 'created_by']));
    }
