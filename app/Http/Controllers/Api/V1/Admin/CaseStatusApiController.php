...
class CaseStatusApiController extends Controller
{
    public function index()
    {
        ...
        return new CaseStatusResource(CaseStatus::with(['complaint_status', 'from_area', 'created_by'])->get());
    }
    ...
    public function show(CaseStatus $caseStatus)
    {
        ...
        return new CaseStatusResource($caseStatus->load(['complaint_status', 'from_area', 'created_by']));
    }
