...
class BillApiController extends Controller
{
    public function index()
    {
        ...
        return new BillResource(Bill::with(['house', 'homeowner', 'bill_items', 'bill_charges', 'bill_status', 'from_area', 'created_by'])->get());
    }
    ...
    public function show(Bill $bill)
    {
        ...
        return new BillResource($bill->load(['house', 'homeowner', 'bill_items', 'bill_charges', 'bill_status', 'from_area', 'created_by']));
    }
