...
class BillItemApiController extends Controller
{
    public function index()
    {
        ...
        return new BillItemResource(BillItem::with(['bill_particular', 'from_area', 'created_by'])->get());
    }
    ...
    public function show(BillItem $billItem)
    {
        ...
        return new BillItemResource($billItem->load(['bill_particular', 'from_area', 'created_by']));
    }
