...
class MyCasesApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new MyCaseResource(MyCase::with(['complaints', 'category', 'status', 'handle_by', 'report_to', 'from_area', 'created_by'])->get());
    }
    ...
    public function show(MyCase $myCase)
    {
        ...
        return new MyCaseResource($myCase->load(['complaints', 'category', 'status', 'handle_by', 'report_to', 'from_area', 'created_by']));
    }
