...
class ContentPageApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new ContentPageResource(ContentPage::with(['categories', 'tags', 'created_by'])->get());
    }
    ...
    public function show(ContentPage $contentPage)
    {
        ...
        return new ContentPageResource($contentPage->load(['categories', 'tags', 'created_by']));
    }
