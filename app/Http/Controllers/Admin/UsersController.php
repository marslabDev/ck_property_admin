...
class UsersController extends Controller
{
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'userUserDetails', 'userUserCardMgmts', 'userPaymentPlans', 'userHomeOwnerTransactions', 'contactPersonManageHouses', 'contactPerson2ManageHouses', 'userUserAlerts', 'ownedByManageHouses');
