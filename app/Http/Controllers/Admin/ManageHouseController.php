...
class ManageHouseController extends Controller
{
    ...
    public function show(ManageHouse $manageHouse)
    {
        ...
        $manageHouse->load('house_type', 'street', 'parking_lots', 'house_status', 'owned_bies', 'contact_person', 'contact_person_2', 'from_area', 'created_by', 'housePaymentPlans', 'houseHomeOwnerTransactions', 'houseBills', 'houseParkingLots');
