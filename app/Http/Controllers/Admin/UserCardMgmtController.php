...
class UserCardMgmtController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.userCardMgmts.index', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.userCardMgmts.create', compact('users'));
    }
    ...
    public function store(StoreUserCardMgmtRequest $request)
    {
        ...
        return redirect()->route('admin.user-card-mgmts.index');
    }
    ...
    public function edit(UserCardMgmt $userCardMgmt)
    {
        ...
        return view('admin.userCardMgmts.edit', compact('userCardMgmt', 'users'));
    }
    ...
    public function show(UserCardMgmt $userCardMgmt)
    {
        ...
        return view('admin.userCardMgmts.show', compact('userCardMgmt'));
    }
