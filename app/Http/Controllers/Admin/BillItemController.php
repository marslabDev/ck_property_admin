...
class BillItemController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = BillItem::with(['bill_particular', 'bill', 'from_area', 'created_by'])->select(sprintf('%s.*', (new BillItem())->table));
            ...
            $table->addColumn('bill_billing_date', function ($row) {
                return $row->bill ? $row->bill->billing_date : '';
            });

            $table->rawColumns(['actions', 'placeholder', 'bill_particular', 'bill']);
        ...
        return view('admin.billItems.index', compact('bill_particulars', 'bills', 'areas', 'users'));
    }
    ...
    public function create()
    {
        ...
        $bills = Bill::pluck('billing_date', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.billItems.create', compact('bill_particulars', 'bills'));
    }
    ...
    public function edit(BillItem $billItem)
    {
        ...
        $billItem->load('bill_particular', 'bill', 'from_area', 'created_by');

        return view('admin.billItems.edit', compact('billItem', 'bill_particulars', 'bills'));
    }
    ...
    public function show(BillItem $billItem)
    {
        ...
        $billItem->load('bill_particular', 'bill', 'from_area', 'created_by', 'billItemBills');
