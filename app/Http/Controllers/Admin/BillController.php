...
class BillController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Bill::with(['bill_type', 'house', 'homeowner', 'bill_items', 'bill_charges', 'bill_status', 'from_area', 'created_by'])->select(sprintf('%s.*', (new Bill())->table));
            ...
            $table->addColumn('bill_type_name', function ($row) {
                return $row->bill_type ? $row->bill_type->name : '';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'bill_type', 'house', 'homeowner', 'bill_item', 'bill_charges', 'bill_status']);
        ...
        return view('admin.bills.index', compact('bill_types', 'manage_houses', 'users', 'bill_items', 'bill_charges', 'bill_statuses', 'areas'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.bills.create', compact('bill_charges', 'bill_items', 'bill_statuses', 'bill_types', 'homeowners', 'houses'));
    }
    ...
    public function edit(Bill $bill)
    {
        ...
        return view('admin.bills.edit', compact('bill', 'bill_charges', 'bill_items', 'bill_statuses', 'bill_types', 'homeowners', 'houses'));
    }
